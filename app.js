...
const renderCurrentWeather = (data)=>{
    ...
    <div id="main">
        ...
        <p>${Math.round(data.main.temp)}˚ʗ</p>
    </div>
    <div id="info">
...
const positionCallback=async (position)=>{
   ...
   const currentData =await getWeatherData ("current",{lat :latitude , lon:longitude});
    renderCurrentWeather(currentData);
    const forecastData  = await getWeatherData ("forecast",{lat :latitude , lon:longitude});
    renderForecastWeather(forecastData)
}
